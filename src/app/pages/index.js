        ...
        <Layout title={'Medly Pharmacy'}>
          ...
          <div className="our-delivery-zones">
            <div className="content-box-left">
              ...
              <br />
              <span className={this.state.ny?"choose-text-active":"choose-text"} onClick={()=>this.changeState(NY)}>New York</span> <span className="choose-text"> / </span> <span className={this.state.nj?"choose-text-active":"choose-text"} onClick={()=>this.changeState(NJ)}>New Jersey</span>
            </div>
